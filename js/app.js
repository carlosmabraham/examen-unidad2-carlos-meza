...
walls.push(new Base(715, 350, 10, 710, "gray"));
walls.push(new Base(20, 730, 695, 10, "gray"));
walls.push(new Base(50, 30, 665, 10, "gray"));9

walls.push(new Base(50,  350, 10, 700, "gray"));
walls.push(new Base(85,  350, 10, 700, "gray"));
walls.push(new Base(120, 350, 10, 700, "gray"));
walls.push(new Base(155, 350, 10, 700, "gray"));
walls.push(new Base(190, 350, 10, 700, "gray"));
walls.push(new Base(225, 350, 10, 690, "gray"));
walls.push(new Base(260, 350, 10, 690, "gray"));
walls.push(new Base(295, 350, 10, 690, "gray"));
walls.push(new Base(330, 350, 10, 690, "gray"));
walls.push(new Base(365, 350, 10, 690, "gray"));
walls.push(new Base(400, 350, 10, 690, "gray"));
walls.push(new Base(435, 350, 10, 690, "gray"));
walls.push(new Base(470, 350, 10, 690, "gray"));
walls.push(new Base(505, 350, 10, 690, "gray"));
walls.push(new Base(540, 350, 10, 690, "gray"));
walls.push(new Base(575, 350, 10, 690, "gray"));
walls.push(new Base(610, 350, 10, 690, "gray"));
walls.push(new Base(645, 350, 10, 690, "gray"));
walls.push(new Base(680, 350, 10, 690, "gray"));
